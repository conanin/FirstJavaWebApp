...
<%@ page import="com.alf.entity.Cart" %>
...
<html>
  ...
  <body>
   <h1>我的购物车</h1>
   <a href="index.jsp">首页</a> >> <a href="ItemsOverview.jsp">商品列表</a>
   <hr> 
   <div id="shopping">
   <form action="" method="">		
			<table>
				...
				<!-- 循环的开始 -->
				     <% 
				         ...
				         HashMap<Item,Integer> goods = cart.getItems();
			 ...
			 <div class="total"><span id="total">总计：<%=cart.calTotalCost() %>￥</span></div>
			  <% 
			    }
			 %>
